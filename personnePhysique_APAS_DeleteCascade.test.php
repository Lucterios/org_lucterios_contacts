...
function org_lucterios_contacts_personnePhysique_APAS_DeleteCascade(&$test)
{
//@CODE_ACTION@
global $connect;
...
try {
	...
	$test->CallAction("org_lucterios_contacts","personneAbstraite_APAS_Delete",array("abstractContact"=>"102","CONFIRME"=>"YES"),"LucteriosException");
	...
	$test->CallAction("org_lucterios_contacts","personneAbstraite_APAS_Delete",array("abstractContact"=>"102","CONFIRME"=>"YES"),"Xfer_Container_Acknowledge");
	...
	$phys=new DBObj_org_lucterios_contacts_personnePhysique;
	$test->assertEquals(0,$phys->find(),'OUT phys nb');
