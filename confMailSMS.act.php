...
$lab->setValue("{[newline]}{[center]}{[underline]}{[bold]}Configuration d?envoi de courriels{[/bold]}{[/underline]}{[/center]}");
...
$SmtpPass=$xfer_result->getComponents('MailSmtpPass');
$SmtpPass->m_value=str_pad('',strlen($SmtpPass->m_value),'*');
