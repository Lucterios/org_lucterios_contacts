...
// --- Last modification: Date 10 January 2010 14:44:56 By  ---
...
$actions[41] = new Param_Action("Valider une personne physique", "personnePhysique_APAS_AddModifyAct", 1);
$actions[42] = new Param_Action("Ajouter/Modifier une personne physique", "personnePhysique_APAS_AddModify", 1);
$actions[43] = new Param_Action("Modifier ma fiche personnelle", "personnePhysique_APAS_EditerPerso", 5);
$actions[44] = new Param_Action("Fiche d'une personne physique", "personnePhysique_APAS_Fiche", 0);
$actions[45] = new Param_Action("Liste des personnes physiques", "personnePhysique_APAS_List", 0);
$actions[46] = new Param_Action("Modifier ma fiche personnelle", "personnePhysique_APAS_ModifFichePerso", 5);
$actions[47] = new Param_Action("Imprimer les étiquettes", "personnePhysique_APAS_PrintEtiquettes", 0);
$actions[48] = new Param_Action("Imprimer une personne physique", "personnePhysique_APAS_PrintFile", 0);
$actions[49] = new Param_Action("Imprimer une liste de personnes physiques", "personnePhysique_APAS_PrintList", 0);
$actions[50] = new Param_Action("Rechercher une personne physique", "personnePhysique_APAS_Search", 0);
$actions[51] = new Param_Action("Modifier la connexion", "personnePhysique_APAS_login", 2);
$actions[52] = new Param_Action("Valider une connexion", "personnePhysique_APAS_validerLogin", 2);
$actions[53] = new Param_Action("ajouts de catégorie de personne morale", "typesMorales_APAS_ajouteract", 0);
$actions[54] = new Param_Action("Ajouter une catégorie de personne morale", "typesMorales_APAS_ajout", 0);
$actions[55] = new Param_Action("Liste des catégories de personnes morales", "typesMorales_APAS_liste", 0);
$actions[56] = new Param_Action("Suppression de catégorie de personne morale", "typesMorales_APAS_suppr", 0);
