...
// --- Last modification: Date 14 July 2009 17:10:54 By  ---
...
//@DESC@Changer les paramètres des contacts
//@PARAM@ 
...
$xfer_result->Caption="Changer les paramètres des contacts";
//@CODE_ACTION@
...
$lab->setValue("{[center]}{[underline]}Paramètres{[/underline]}{[/center]}{[newline]}");
